...
addClassNameListener("html", function(e){
  console.log(e)
  if(e.includes("dark")){
    document.querySelector("#darkmode-icon").classList.add("fa-sun")
    document.querySelector("#darkmode-icon").classList.remove("fa-moon")
  }
  else{
    document.querySelector("#darkmode-icon").classList.add("fa-moon")
    document.querySelector("#darkmode-icon").classList.remove("fa-sun")
  }
});